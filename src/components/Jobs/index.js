...
class Jobs extends Component {
  ...
  getProfileDetails = async () => {
    ...
    const url='https://careerconnect-backend-gx9j.onrender.com/profile'; 
  ...
  getJobs = async () => {
    ...
    const url = `https://careerconnect-backend-gx9j.onrender.com/jobs?employment_type=${employmentTypeString}&minimum_package=${salaryRange}&search=${searchInput}`
                ...
                {salaryRangesList.map(each => (
                  <li key={each.salaryRangeId}>
                    <input
                      ...
                      checked={this.state.salaryRange === each.salaryRangeId}
